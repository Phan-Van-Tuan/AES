...
public class TestView extends JFrame {
    ...
    public TestView() {
    	setTitle("AES Encryption");
		  ...
		  // Initialize panels
	      panelEncryption = new CryptionPanel(
				  encryptButton,
				  enFile,
	    		  endFile,
	    		  enKey,
	    		  enProgressBar,
	    		  enTime);
	      panelDecryption = new CryptionPanel(
	    		  decryptButton, 
	    		  deFile,
	    		  dedFile,
	    		  deKey,
	...
	private class CryptionPanel extends JPanel {
        public CryptionPanel(
        		JButton button,
        		JTextField file,
        		JTextField newFile,
        		JTextField key,
        		final JProgressBar progressBar,
        		JTextField timeProcess) {
            ...
            panelMaterial.setBorder(new CompoundBorder(
            ...
            panelProcess.setBorder(new CompoundBorder(
            	new TitledBorder("Process"), 
            	new EmptyBorder(4, 4, 4, 4)
            ));
            ...
            panelResult.setBorder(new CompoundBorder(
